    ...
    return(
        <section className="w-full flex mb-6 flex-col items-center relative">
            ...
            <section className="w-[90%] mt-5 flex flex-row flex-nowrap gap-2 justify-center overflow-hidden">
                ...
                <div key={index} className="w-full lg:w-[32%] bg-background-secondary p-2 flex flex-col items-center rounded-md transition-transform important-min-height">
                    <img
            ...
            {showArrowContainer && (
                <section className="absolute top-[60%] flex w-full justify-between items-center md:px-2.5">
                    <button 
                        id="lessThanButton"
                        onClick={handlePrev} 
